...
class AcademicValidator:
    ...
    def validate_system(self, integrated_system):
        ...
        predicted_prices = []
        actual_prices = test_prices[1:]  # Next day actual prices
    ...
    def print_report(self, results):
        ...
        print(f"  MAE: {acc[\"MAE\"]:.3f} TL")
        print(f"  RMSE: {acc[\"RMSE\"]:.3f} TL") 
        print(f"  MAPE: {acc[\"MAPE\"]:.2f}%")
        print(f"  Directional Accuracy: {acc[\"Directional_Accuracy\"]:.1f}%")
        print(f"  Correlation: {acc[\"Correlation\"]:.3f}")
        print(f"  R-Squared: {acc[\"R_Squared\"]:.3f}")
        ...
        print()
        print(f"ACADEMIC PERFORMANCE SCORE: {academic_score:.1f}%")
